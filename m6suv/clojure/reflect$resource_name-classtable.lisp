; reflect$resource_name-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:57 CDT 2014.
;

(defconst *clojure.reflect$resource_name*
 (make-class-def
      '(class "clojure.reflect$resource_name"
            ...
            (methods
					...
					(methodCP "var" "clojure.lang.RT" ((class "java.lang.String") (class "java.lang.String")) (class "clojure.lang.Var"))))
                                      ...
                                      (10 (putstatic (fieldCP "const__0" "clojure.reflect$resource_name" (class "clojure.lang.Var"))))
                                      (13 (ldc 2))        ;;STRING:: "clojure.string"
                                      (15 (ldc 3))        ;;STRING:: "replace"
                                      (17 (invokestatic
					(methodCP "var" "clojure.lang.RT" ((class "java.lang.String") (class "java.lang.String")) (class "clojure.lang.Var"))))
                                      (20 (checkcast (class "clojure.lang.Var")))
                                      (23 (putstatic (fieldCP "const__1" "clojure.reflect$resource_name" (class "clojure.lang.Var"))))
                                      (26 (ldc 4))        ;;STRING:: "clojure.reflect"
                                      (28 (ldc 5))        ;;STRING:: "typename"
                                      (30 (invokestatic
					(methodCP "var" "clojure.lang.RT" ((class "java.lang.String") (class "java.lang.String")) (class "clojure.lang.Var"))))
                                      (33 (checkcast (class "clojure.lang.Var")))
                                      (36 (putstatic (fieldCP "const__2" "clojure.reflect$resource_name" (class "clojure.lang.Var"))))
                                      (39 (return))
                                      (endofcode 40))
                                   (Exceptions )
                                   (StackMap )))
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                        ...
                        (method "invoke"
                              ...
                              (accessflags  *class*  *public* )
                              (code
                                   (max_stack . 5) (max_locals . 2) (code_length . 85)
                                   (parsedcode
                                      (0 (getstatic (fieldCP "const__0" "clojure.reflect$resource_name" (class "clojure.lang.Var")))) 
                                      (3 (invokevirtual (methodCP "getRawRoot" "clojure.lang.Var" () (class "java.lang.Object")))) 
                                      (6 (checkcast (class "clojure.lang.IFn"))) 
                                      (9 (getstatic (fieldCP "const__1" "clojure.reflect$resource_name" (class "clojure.lang.Var")))) 
                                      ...
                                      (25 (aload_0)) 
                                      (26 (getfield (fieldCP "__cached_class__0" "clojure.reflect$resource_name" (class "java.lang.Class")))) 
                                      ...
                                      (43 (aload_0)) 
                                      (44 (swap)) 
                                      (45 (putfield (fieldCP "__cached_class__0" "clojure.reflect$resource_name" (class "java.lang.Class")))) 
                                      (48 (getstatic (fieldCP "const__2" "clojure.reflect$resource_name" (class "clojure.lang.Var")))) ;;at TAG_0
...
(defconst *reflect$resource_name-class-table*
  (make-static-class-decls 
   *clojure.reflect$resource_name*))

(defconst *package-name-map* 
  ("clojure.reflect$resource_name" . "clojure"))
