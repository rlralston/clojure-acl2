; core$coll_QMARK_-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:41 CDT 2014.
;

(defconst *clojure.core$coll_QMARK_*
 (make-class-def
      '(class "clojure.core$coll_QMARK_"
            ...
            (methods
					...
					(methodCP "var" "clojure.lang.RT" ((class "java.lang.String") (class "java.lang.String")) (class "clojure.lang.Var"))))
                                      ...
                                      (10 (putstatic (fieldCP "const__0" "clojure.core$coll_QMARK_" (class "clojure.lang.Var"))))
                                      (13 (return))
                                      (endofcode 14))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (aconst_null)) 
                                      (2 (astore_1)) 
                                      (3 (instanceof (class "clojure.lang.IPersistentCollection"))) 
                                      (6 (ifeq 15))  ;;to TAG_0
...
(defconst *core$coll_QMARK_-class-table*
  (make-static-class-decls 
   *clojure.core$coll_QMARK_*))

(defconst *package-name-map* 
  ("clojure.core$coll_QMARK_" . "clojure"))
