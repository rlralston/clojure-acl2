; core$boolean-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:40 CDT 2014.
;

(defconst *clojure.core$boolean*
 (make-class-def
      '(class "clojure.core$boolean"
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (aconst_null)) 
                                      (2 (astore_1)) 
                                      (3 (invokestatic (methodCP "booleanCast" "clojure.lang.RT" ((class "java.lang.Object")) boolean))) 
                                      (6 (ifeq 15))  ;;to TAG_0
...
(defconst *core$boolean-class-table*
  (make-static-class-decls 
   *clojure.core$boolean*))

(defconst *package-name-map* 
  ("clojure.core$boolean" . "clojure"))
