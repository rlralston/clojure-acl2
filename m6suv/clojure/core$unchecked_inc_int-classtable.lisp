; core$unchecked_inc_int-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:45 CDT 2014.
;

(defconst *clojure.core$unchecked_inc_int*
 (make-class-def
      '(class "clojure.core$unchecked_inc_int"
            ...
            (methods
					...
					(methodCP "intCast" "clojure.lang.RT" ((class "java.lang.Object")) int)))
                                      (9 (invokestatic
					(methodCP "unchecked_int_inc" "clojure.lang.Numbers" (int) int)))
                                      (12 (invokestatic
...
(defconst *core$unchecked_inc_int-class-table*
  (make-static-class-decls 
   *clojure.core$unchecked_inc_int*))

(defconst *package-name-map* 
  ("clojure.core$unchecked_inc_int" . "clojure"))
