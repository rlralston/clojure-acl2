; pprint$fn__8220-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:55 CDT 2014.
;

(defconst *clojure.pprint$fn__8220*
 (make-class-def
      '(class "clojure.pprint$fn__8220"
            ...
            (methods
					...
					(methodCP "var" "clojure.lang.RT" ((class "java.lang.String") (class "java.lang.String")) (class "clojure.lang.Var"))))
                                      ...
                                      (10 (putstatic (fieldCP "const__0" "clojure.pprint$fn__8220" (class "clojure.lang.Var"))))
                                      (13 (ldc 2))        ;;STRING:: "clojure.pprint"
                                      (15 (ldc 3))        ;;STRING:: "cached-compile"
                                      (17 (invokestatic
					(methodCP "var" "clojure.lang.RT" ((class "java.lang.String") (class "java.lang.String")) (class "clojure.lang.Var"))))
                                      (20 (checkcast (class "clojure.lang.Var")))
                                      (23 (putstatic (fieldCP "const__1" "clojure.pprint$fn__8220" (class "clojure.lang.Var"))))
                                      (26 (return))
                                      (endofcode 27))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (ldc 4)) ;;STRING:: "~<<-(~;~@{~w~^ ~_~}~;)-<~:>"
                                      (2 (astore_1)) 
                                      (3 (getstatic (fieldCP "const__0" "clojure.pprint$fn__8220" (class "clojure.lang.Var")))) 
                                      ...
                                      (28 (getstatic (fieldCP "const__1" "clojure.pprint$fn__8220" (class "clojure.lang.Var")))) 
                                      ...
                                      (50 (new (class "clojure.pprint$fn__8220$fn__8221"))) 
                                      (53 (dup)) 
                                      (54 (aload_2)) 
                                      (55 (aconst_null)) 
                                      (56 (astore_2)) 
                                      (57 (invokespecial (methodCP "<init>" "clojure.pprint$fn__8220$fn__8221" ((class "java.lang.Object")) void))) 
                                      (60 (areturn)) 
                                      (endofcode 61))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *pprint$fn__8220-class-table*
  (make-static-class-decls 
   *clojure.pprint$fn__8220*))

(defconst *package-name-map* 
  ("clojure.pprint$fn__8220" . "clojure"))
