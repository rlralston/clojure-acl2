; pprint$write_line-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:57 CDT 2014.
;

(defconst *clojure.pprint$write_line*
 (make-class-def
      '(class "clojure.pprint$write_line"
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (new (class "clojure.pprint$write_line$fn__7493")))
                                      (3 (dup))
                                      (4 (aload_1))
                                      (5 (aconst_null))
                                      (6 (astore_1))
                                      (7 (invokespecial
					(methodCP "<init>" "clojure.pprint$write_line$fn__7493" ((class "java.lang.Object")) void)))
...
(defconst *pprint$write_line-class-table*
  (make-static-class-decls 
   *clojure.pprint$write_line*))

(defconst *package-name-map* 
  ("clojure.pprint$write_line" . "clojure"))
