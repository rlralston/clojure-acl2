; string$upper_case-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:58 CDT 2014.
;

(defconst *clojure.string$upper_case*
 (make-class-def
      '(class "clojure.string$upper_case"
            ...
            (methods
					...
					(methodCP "toString" "java.lang.Object" () (class "java.lang.String"))))
                                      ...
                                      (9 (invokevirtual
					(methodCP "toUpperCase" "java.lang.String" () (class "java.lang.String"))))
                                      (12 (areturn))
                                      (endofcode 13))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *string$upper_case-class-table*
  (make-static-class-decls 
   *clojure.string$upper_case*))

(defconst *package-name-map* 
  ("clojure.string$upper_case" . "clojure"))
