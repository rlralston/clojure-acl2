; core$unchecked_multiply_int-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:45 CDT 2014.
;

(defconst *clojure.core$unchecked_multiply_int*
 (make-class-def
      '(class "clojure.core$unchecked_multiply_int"
            ...
            (methods
					...
					(methodCP "intCast" "clojure.lang.RT" ((class "java.lang.Object")) int)))
                                      (18 (invokestatic
					(methodCP "unchecked_int_multiply" "clojure.lang.Numbers" (int int) int)))
                                      (21 (invokestatic
...
(defconst *core$unchecked_multiply_int-class-table*
  (make-static-class-decls 
   *clojure.core$unchecked_multiply_int*))

(defconst *package-name-map* 
  ("clojure.core$unchecked_multiply_int" . "clojure"))
