; core$chunk_buffer-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:41 CDT 2014.
;

(defconst *clojure.core$chunk_buffer*
 (make-class-def
      '(class "clojure.core$chunk_buffer"
            ...
            (methods
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (new (class "clojure.lang.ChunkBuffer")))
                                      (3 (dup))
                                      (4 (aload_1))
                                      (5 (aconst_null))
                                      (6 (astore_1))
					...
					(methodCP "intCast" "clojure.lang.RT" ((class "java.lang.Object")) int)))
                                      (13 (invokespecial
					(methodCP "<init>" "clojure.lang.ChunkBuffer" (int) void)))
                                      (16 (areturn))
                                      (endofcode 17))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *core$chunk_buffer-class-table*
  (make-static-class-decls 
   *clojure.core$chunk_buffer*))

(defconst *package-name-map* 
  ("clojure.core$chunk_buffer" . "clojure"))
