; string$lower_case-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:58 CDT 2014.
;

(defconst *clojure.string$lower_case*
 (make-class-def
      '(class "clojure.string$lower_case"
...
(defconst *string$lower_case-class-table*
  (make-static-class-decls 
   *clojure.string$lower_case*))

(defconst *package-name-map* 
  ("clojure.string$lower_case" . "clojure"))
