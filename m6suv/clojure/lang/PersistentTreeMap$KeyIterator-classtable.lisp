; PersistentTreeMap$KeyIterator-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:52 CDT 2014.
;

(defconst *clojure.lang.PersistentTreeMap$KeyIterator*
 (make-class-def
      '(class "clojure.lang.PersistentTreeMap$KeyIterator"
            "java.lang.Object"
            (constant_pool)
            (fields
            ...
            (methods
					...
					(methodCP "<init>" "java.lang.Object" () void)))
                                      (4 (aload_0))
                                      (5 (aload_1))
                                      (6 (putfield (fieldCP "it" "clojure.lang.PersistentTreeMap$KeyIterator" (class "clojure.lang.PersistentTreeMap$NodeIterator"))))
                                      (9 (return))
                                      (endofcode 10))
                                   (Exceptions )
                                   (StackMap )))
                        (method "hasNext"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (getfield (fieldCP "it" "clojure.lang.PersistentTreeMap$KeyIterator" (class "clojure.lang.PersistentTreeMap$NodeIterator"))))
                                      (4 (invokevirtual
...
(defconst *PersistentTreeMap$KeyIterator-class-table*
  (make-static-class-decls 
   *clojure.lang.PersistentTreeMap$KeyIterator*))

(defconst *package-name-map* 
  ("clojure.lang.PersistentTreeMap$KeyIterator" . "clojure.lang"))
