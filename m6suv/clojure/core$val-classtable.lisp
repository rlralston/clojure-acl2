; core$val-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:46 CDT 2014.
;

(defconst *clojure.core$val*
 (make-class-def
      '(class "clojure.core$val"
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (aconst_null))
                                      (2 (astore_1))
                                      (3 (checkcast (class "java.util.Map$Entry")))
                                      (6 (invokeinterface
...
(defconst *core$val-class-table*
  (make-static-class-decls 
   *clojure.core$val*))

(defconst *package-name-map* 
  ("clojure.core$val" . "clojure"))
