; core$generate_class$fn__5603-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:42 CDT 2014.
;

(defconst *clojure.core$generate_class$fn__5603*
 (make-class-def
      '(class "clojure.core$generate_class$fn__5603"
            ...
            (methods
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                                      (4 (aload_0))
                                      (5 (aload_1))
                                      (6 (putfield (fieldCP "super_type" "clojure.core$generate_class$fn__5603" (class "java.lang.Object"))))
                                      (9 (return))
                                      (endofcode 10))
                                   (Exceptions )
                                   (StackMap )))
					...
					(methodCP "loadArgs" "clojure.asm.commons.GeneratorAdapter" () void)))
                                      ...
                                      (27 (aload_0))
                                      (28 (getfield (fieldCP "super_type" "clojure.core$generate_class$fn__5603" (class "java.lang.Object"))))
...
(defconst *core$generate_class$fn__5603-class-table*
  (make-static-class-decls 
   *clojure.core$generate_class$fn__5603*))

(defconst *package-name-map* 
  ("clojure.core$generate_class$fn__5603" . "clojure"))
