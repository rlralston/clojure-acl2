; pprint$fn__7456-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:55 CDT 2014.
;

(defconst *clojure.pprint$fn__7456*
 (make-class-def
      '(class "clojure.pprint$fn__7456"
            ...
            (methods
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                        ...
                        (method "invoke"
                              ...
                              (accessflags  *class*  *public* )
                              (code
                                   (max_stack . 1) (max_locals . 5) (code_length . 4)
                                   (parsedcode
...
(defconst *pprint$fn__7456-class-table*
  (make-static-class-decls 
   *clojure.pprint$fn__7456*))

(defconst *package-name-map* 
  ("clojure.pprint$fn__7456" . "clojure"))
