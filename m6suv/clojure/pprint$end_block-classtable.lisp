; pprint$end_block-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:55 CDT 2014.
;

(defconst *clojure.pprint$end_block*
 (make-class-def
      '(class "clojure.pprint$end_block"
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                        ...
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (new (class "clojure.pprint$end_block$fn__7540")))
                                      (3 (dup))
                                      (4 (aload_1))
                                      (5 (aconst_null))
                                      (6 (astore_1))
                                      (7 (invokespecial
					(methodCP "<init>" "clojure.pprint$end_block$fn__7540" ((class "java.lang.Object")) void)))
...
(defconst *pprint$end_block-class-table*
  (make-static-class-decls 
   *clojure.pprint$end_block*))

(defconst *package-name-map* 
  ("clojure.pprint$end_block" . "clojure"))
