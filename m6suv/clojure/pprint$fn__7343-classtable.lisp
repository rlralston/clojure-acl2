; pprint$fn__7343-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:55 CDT 2014.
;

(defconst *clojure.pprint$fn__7343*
 (make-class-def
      '(class "clojure.pprint$fn__7343"
            "clojure.lang.AFunction"
            (constant_pool
                        (STRING  "clojure.pprint.PrettyFlush"))
            (fields)
            (methods
                        (method "<clinit>"
                              (parameters )
					...
					(methodCP "deref" "clojure.lang.Var" () (class "java.lang.Object"))))
                                      ...
                                      (11 (ldc 0))        ;;STRING:: "clojure.pprint.PrettyFlush"
                                      (13 (invokestatic
...
(defconst *pprint$fn__7343-class-table*
  (make-static-class-decls 
   *clojure.pprint$fn__7343*))

(defconst *package-name-map* 
  ("clojure.pprint$fn__7343" . "clojure"))
