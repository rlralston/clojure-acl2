; core$unchecked_add_int-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:45 CDT 2014.
;

(defconst *clojure.core$unchecked_add_int*
 (make-class-def
      '(class "clojure.core$unchecked_add_int"
            ...
            (methods
					...
					(methodCP "intCast" "clojure.lang.RT" ((class "java.lang.Object")) int)))
                                      (18 (invokestatic
					(methodCP "unchecked_int_add" "clojure.lang.Numbers" (int int) int)))
                                      (21 (invokestatic
...
(defconst *core$unchecked_add_int-class-table*
  (make-static-class-decls 
   *clojure.core$unchecked_add_int*))

(defconst *package-name-map* 
  ("clojure.core$unchecked_add_int" . "clojure"))
