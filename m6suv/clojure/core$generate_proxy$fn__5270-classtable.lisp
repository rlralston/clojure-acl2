; core$generate_proxy$fn__5270-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:28:43 CDT 2014.
;

(defconst *clojure.core$generate_proxy$fn__5270*
 (make-class-def
      '(class "clojure.core$generate_proxy$fn__5270"
            ...
            (methods
					...
					(methodCP "<init>" "clojure.lang.AFunction" () void)))
                                      (4 (aload_0))
                                      (5 (aload_1))
                                      (6 (putfield (fieldCP "ex_type" "clojure.core$generate_proxy$fn__5270" (class "java.lang.Object"))))
                                      (9 (return))
                                      (endofcode 10))
                                   (Exceptions )
                                   (StackMap )))
                        (method "invoke"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (6 (aload_0))
                                      (7 (getfield (fieldCP "ex_type" "clojure.core$generate_proxy$fn__5270" (class "java.lang.Object"))))
...
(defconst *core$generate_proxy$fn__5270-class-table*
  (make-static-class-decls 
   *clojure.core$generate_proxy$fn__5270*))

(defconst *package-name-map* 
  ("clojure.core$generate_proxy$fn__5270" . "clojure"))
