; UnicodeProp$2-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.UnicodeProp$2*
 (make-class-def
      '(class "java.util.regex.UnicodeProp$2"
...
(defconst *UnicodeProp$2-class-table*
  (make-static-class-decls 
   *java.util.regex.UnicodeProp$2*))

(defconst *package-name-map* 
  ("java.util.regex.UnicodeProp$2" . "java.util.regex"))
