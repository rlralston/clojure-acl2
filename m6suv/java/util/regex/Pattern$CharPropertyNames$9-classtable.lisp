; Pattern$CharPropertyNames$9-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.Pattern$CharPropertyNames$9*
 (make-class-def
      '(class "java.util.regex.Pattern$CharPropertyNames$9"
                        ...
                        (method "isSatisfiedBy"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (iload_1))
                                      (1 (invokestatic
					(methodCP "isIdeographic" "java.lang.Character" (int) boolean)))
                                      (4 (ireturn))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *Pattern$CharPropertyNames$9-class-table*
  (make-static-class-decls 
   *java.util.regex.Pattern$CharPropertyNames$9*))

(defconst *package-name-map* 
  ("java.util.regex.Pattern$CharPropertyNames$9" . "java.util.regex"))
