; Pattern$5-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.Pattern$5*
 (make-class-def
      '(class "java.util.regex.Pattern$5"
                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "val$lhs" "java.util.regex.Pattern$5" (class "java.util.regex.Pattern$CharProperty"))))
                                      (5 (aload_0))
                                      (6 (aload_2))
                                      (7 (putfield (fieldCP "val$rhs" "java.util.regex.Pattern$5" (class "java.util.regex.Pattern$CharProperty"))))
                                      (10 (aload_0))
                                      (11 (aconst_null))
                                      (12 (invokespecial
					(methodCP "<init>" "java.util.regex.Pattern$CharProperty" ((class "java.util.regex.Pattern$1")) void)))
                        ...
                        (method "isSatisfiedBy"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0)) 
                                      (1 (getfield (fieldCP "val$lhs" "java.util.regex.Pattern$5" (class "java.util.regex.Pattern$CharProperty")))) 
                                      (4 (iload_1)) 
                                      (5 (invokevirtual (methodCP "isSatisfiedBy" "java.util.regex.Pattern$CharProperty" (int) boolean))) 
                                      (8 (ifne 22)) ;;to TAG_0
                                      (11 (aload_0)) 
                                      (12 (getfield (fieldCP "val$rhs" "java.util.regex.Pattern$5" (class "java.util.regex.Pattern$CharProperty")))) 
                                      (15 (iload_1)) 
...
(defconst *Pattern$5-class-table*
  (make-static-class-decls 
   *java.util.regex.Pattern$5*))

(defconst *package-name-map* 
  ("java.util.regex.Pattern$5" . "java.util.regex"))
