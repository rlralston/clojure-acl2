; UnicodeProp$6-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.UnicodeProp$6*
 (make-class-def
      '(class "java.util.regex.UnicodeProp$6"
...
(defconst *UnicodeProp$6-class-table*
  (make-static-class-decls 
   *java.util.regex.UnicodeProp$6*))

(defconst *package-name-map* 
  ("java.util.regex.UnicodeProp$6" . "java.util.regex"))
