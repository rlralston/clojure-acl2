; Pattern$CharPropertyNames$6-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.Pattern$CharPropertyNames$6*
 (make-class-def
      '(class "java.util.regex.Pattern$CharPropertyNames$6"
...
(defconst *Pattern$CharPropertyNames$6-class-table*
  (make-static-class-decls 
   *java.util.regex.Pattern$CharPropertyNames$6*))

(defconst *package-name-map* 
  ("java.util.regex.Pattern$CharPropertyNames$6" . "java.util.regex"))
