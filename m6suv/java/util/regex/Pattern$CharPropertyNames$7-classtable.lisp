; Pattern$CharPropertyNames$7-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.Pattern$CharPropertyNames$7*
 (make-class-def
      '(class "java.util.regex.Pattern$CharPropertyNames$7"
...
(defconst *Pattern$CharPropertyNames$7-class-table*
  (make-static-class-decls 
   *java.util.regex.Pattern$CharPropertyNames$7*))

(defconst *package-name-map* 
  ("java.util.regex.Pattern$CharPropertyNames$7" . "java.util.regex"))
