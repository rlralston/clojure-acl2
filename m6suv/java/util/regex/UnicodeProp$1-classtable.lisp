; UnicodeProp$1-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.regex.UnicodeProp$1*
 (make-class-def
      '(class "java.util.regex.UnicodeProp$1"
...
(defconst *UnicodeProp$1-class-table*
  (make-static-class-decls 
   *java.util.regex.UnicodeProp$1*))

(defconst *package-name-map* 
  ("java.util.regex.UnicodeProp$1" . "java.util.regex"))
