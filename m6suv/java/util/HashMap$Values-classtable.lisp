                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "this$0" "java.util.HashMap$Values" (class "java.util.HashMap"))))
                                      (5 (aload_0))
                                      (6 (invokespecial
					(methodCP "<init>" "java.util.AbstractCollection" () void)))
                        ...
                        (method "iterator"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (getfield (fieldCP "this$0" "java.util.HashMap$Values" (class "java.util.HashMap"))))
                                      (4 (invokevirtual
					(methodCP "newValueIterator" "java.util.HashMap" () (class "java.util.Iterator"))))
                                      (7 (areturn))
                                      (endofcode 8))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (aload_1))
                                      (2 (invokespecial
					(methodCP "<init>" "java.util.HashMap$Values" ((class "java.util.HashMap")) void)))
                                      (5 (return))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *HashMap$Values-class-table*
  (make-static-class-decls 
   *java.util.HashMap$Values*))

(defconst *package-name-map* 
  ("java.util.HashMap$Values" . "java.util"))
