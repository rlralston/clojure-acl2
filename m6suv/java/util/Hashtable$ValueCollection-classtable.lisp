; Hashtable$ValueCollection-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:45 CDT 2014.
;

(defconst *java.util.Hashtable$ValueCollection*
 (make-class-def
                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "this$0" "java.util.Hashtable$ValueCollection" (class "java.util.Hashtable"))))
                                      (5 (aload_0))
                                      (6 (invokespecial
					(methodCP "<init>" "java.util.AbstractCollection" () void)))
                        ...
                        (method "iterator"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (getfield (fieldCP "this$0" "java.util.Hashtable$ValueCollection" (class "java.util.Hashtable"))))
                                      (4 (iconst_1))
                                      (5 (invokestatic
                        ...
                        (method "contains"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (4 (aload_1))
                                      (5 (invokevirtual
					(methodCP "containsValue" "java.util.Hashtable" ((class "java.lang.Object")) boolean)))
                                      (8 (ireturn))
                                      (endofcode 9))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (aload_1))
                                      (2 (invokespecial
					(methodCP "<init>" "java.util.Hashtable$ValueCollection" ((class "java.util.Hashtable")) void)))
                                      (5 (return))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *Hashtable$ValueCollection-class-table*
  (make-static-class-decls 
   *java.util.Hashtable$ValueCollection*))

(defconst *package-name-map* 
  ("java.util.Hashtable$ValueCollection" . "java.util"))
