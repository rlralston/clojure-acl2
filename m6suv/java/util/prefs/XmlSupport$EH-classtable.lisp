; XmlSupport$EH-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.prefs.XmlSupport$EH*
 (make-class-def
                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (invokespecial
					(methodCP "<init>" "java.util.prefs.XmlSupport$EH" () void)))
                                      (4 (return))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *XmlSupport$EH-class-table*
  (make-static-class-decls 
   *java.util.prefs.XmlSupport$EH*))

(defconst *package-name-map* 
  ("java.util.prefs.XmlSupport$EH" . "java.util.prefs"))
