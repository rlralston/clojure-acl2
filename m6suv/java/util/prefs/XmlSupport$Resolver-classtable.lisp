; XmlSupport$Resolver-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:47 CDT 2014.
;

(defconst *java.util.prefs.XmlSupport$Resolver*
 (make-class-def
					...
					(methodCP "<init>" "java.lang.Object" () void)))
                        ...
                        (method "resolveEntity"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_2)) 
                                      (1 (ldc 0)) ;;STRING:: "http://java.sun.com/dtd/preferences.dtd"
                                      ...
                                      (16 (dup)) 
                                      (17 (ldc 1)) ;;STRING:: "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!-- DTD for preferences --><!ELEMENT preferences (root) ><!ATTLIST preferences EXTERNAL_XML_VERSION CDATA \"0.0\"  ><!ELEMENT root (map, node*) ><!ATTLIST root          type (system|user) #REQUIRED ><!ELEMENT node (map, node*) ><!ATTLIST node          name CDATA #REQUIRED ><!ELEMENT map (entry*) ><!ATTLIST map  MAP_XML_VERSION CDATA \"0.0\"  ><!ELEMENT entry EMPTY ><!ATTLIST entry          key CDATA #REQUIRED          value CDATA #REQUIRED >"
                                      ...
                                      (25 (astore_3)) 
                                      (26 (aload_3)) 
                                      (27 (ldc 0)) ;;STRING:: "http://java.sun.com/dtd/preferences.dtd"
                                   ...
                                   (StackMap )))
                        (method "<init>"
                              (parameters (class "java.util.prefs.XmlSupport$1"))
                              (returntype . void)
                              (accessflags  *class* )
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (invokespecial
					(methodCP "<init>" "java.util.prefs.XmlSupport$Resolver" () void)))
                                      (4 (return))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *XmlSupport$Resolver-class-table*
  (make-static-class-decls 
   *java.util.prefs.XmlSupport$Resolver*))

(defconst *package-name-map* 
  ("java.util.prefs.XmlSupport$Resolver" . "java.util.prefs"))
