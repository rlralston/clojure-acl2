...
(defconst *ZipException-class-table*
  (make-static-class-decls 
   *java.util.zip.ZipException*))

(defconst *package-name-map* 
  ("java.util.zip.ZipException" . "java.util.zip"))
