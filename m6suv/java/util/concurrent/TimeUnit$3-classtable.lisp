; TimeUnit$3-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:44 CDT 2014.
;

(defconst *java.util.concurrent.TimeUnit$3*
 (make-class-def
      '(class "java.util.concurrent.TimeUnit$3"
					...
					(methodCP "<init>" "java.util.concurrent.TimeUnit" ((class "java.lang.String") int (class "java.util.concurrent.TimeUnit$1")) void)))
                        ...
                        (method "toNanos"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 0))      ;; LONG:: "1000000"
                                      (4 (ldc2_w 1))      ;; LONG:: "9223372036854"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$3" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                                   (Exceptions )
                                   (StackMap )))
                        (method "toMicros"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 2))      ;; LONG:: "1000"
                                      (4 (ldc2_w 3))      ;; LONG:: "9223372036854775"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$3" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
...
(defconst *TimeUnit$3-class-table*
  (make-static-class-decls 
   *java.util.concurrent.TimeUnit$3*))

(defconst *package-name-map* 
  ("java.util.concurrent.TimeUnit$3" . "java.util.concurrent"))
