					...
					(methodCP "<init>" "java.util.concurrent.TimeUnit" ((class "java.lang.String") int (class "java.util.concurrent.TimeUnit$1")) void)))
                        ...
                        (method "toNanos"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 0))      ;; LONG:: "60000000000"
                                      (4 (ldc2_w 1))      ;; LONG:: "153722867"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$5" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                                   (Exceptions )
                                   (StackMap )))
                        (method "toMicros"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 2))      ;; LONG:: "60000000"
                                      (4 (ldc2_w 3))      ;; LONG:: "153722867280"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$5" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                        ...
                        (method "toMillis"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 4))      ;; LONG:: "60000"
                                      (4 (ldc2_w 5))      ;; LONG:: "153722867280912"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$5" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                        ...
                        (method "toSeconds"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 6))      ;; LONG:: "60"
                                      (4 (ldc2_w 7))      ;; LONG:: "153722867280912930"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$5" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                        ...
                        (method "convert"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (lload_1))
                                      (2 (invokevirtual
					(methodCP "toMinutes" "java.util.concurrent.TimeUnit" (long) long)))
                                      (5 (lreturn))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap )))
...
(defconst *TimeUnit$5-class-table*
  (make-static-class-decls 
   *java.util.concurrent.TimeUnit$5*))

(defconst *package-name-map* 
  ("java.util.concurrent.TimeUnit$5" . "java.util.concurrent"))
