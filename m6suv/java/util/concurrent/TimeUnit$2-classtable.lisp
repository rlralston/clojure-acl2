; TimeUnit$2-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:44 CDT 2014.
;

(defconst *java.util.concurrent.TimeUnit$2*
 (make-class-def
      '(class "java.util.concurrent.TimeUnit$2"
                        ...
                        (method "toNanos"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (4 (ldc2_w 1))      ;; LONG:: "9223372036854775"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$2" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "convert"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (lload_1))
                                      (2 (invokevirtual
					(methodCP "toMicros" "java.util.concurrent.TimeUnit" (long) long)))
                                      (5 (lreturn))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap )))
...
(defconst *TimeUnit$2-class-table*
  (make-static-class-decls 
   *java.util.concurrent.TimeUnit$2*))

(defconst *package-name-map* 
  ("java.util.concurrent.TimeUnit$2" . "java.util.concurrent"))
