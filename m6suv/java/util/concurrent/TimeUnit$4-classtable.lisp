					...
					(methodCP "<init>" "java.util.concurrent.TimeUnit" ((class "java.lang.String") int (class "java.util.concurrent.TimeUnit$1")) void)))
                        ...
                        (method "toNanos"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 0))      ;; LONG:: "1000000000"
                                      (4 (ldc2_w 1))      ;; LONG:: "9223372036"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$4" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                                   (Exceptions )
                                   (StackMap )))
					...
					(methodCP "x" "java.util.concurrent.TimeUnit$4" (long long long) long)))
                        ...
                        (method "toMillis"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (lload_1))
                                      (1 (ldc2_w 4))      ;; LONG:: "1000"
                                      (4 (ldc2_w 5))      ;; LONG:: "9223372036854775"
                                      (7 (invokestatic
					(methodCP "x" "java.util.concurrent.TimeUnit$4" (long long long) long)))
                                      (10 (lreturn))
                                      (endofcode 11))
                        ...
                        (method "convert"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (lload_1))
                                      (2 (invokevirtual
					(methodCP "toSeconds" "java.util.concurrent.TimeUnit" (long) long)))
                                      (5 (lreturn))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap )))
...
(defconst *TimeUnit$4-class-table*
  (make-static-class-decls 
   *java.util.concurrent.TimeUnit$4*))

(defconst *package-name-map* 
  ("java.util.concurrent.TimeUnit$4" . "java.util.concurrent"))
