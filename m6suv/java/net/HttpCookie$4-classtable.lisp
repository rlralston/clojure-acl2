					...
					(methodCP "<init>" "java.lang.Object" () void)))
                        ...
                        (method "assign"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_1)) 
                                      (1 (invokevirtual (methodCP "getDomain" "java.net.HttpCookie" () (class "java.lang.String")))) 
                                      (4 (ifnonnull 12))  ;;to TAG_0
                                      (7 (aload_1)) 
                                      (8 (aload_3)) 
                                      (9 (invokevirtual (methodCP "setDomain" "java.net.HttpCookie" ((class "java.lang.String")) void))) 
                                      (12 (return)) ;;at TAG_0
                                      (endofcode 13))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *HttpCookie$4-class-table*
  (make-static-class-decls 
   *java.net.HttpCookie$4*))

(defconst *package-name-map* 
  ("java.net.HttpCookie$4" . "java.net"))
