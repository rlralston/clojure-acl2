...
(defconst *ProtocolException-class-table*
  (make-static-class-decls 
   *java.net.ProtocolException*))

(defconst *package-name-map* 
  ("java.net.ProtocolException" . "java.net"))
