; SocksSocketImpl$5-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:37 CDT 2014.
;

(defconst *java.net.SocksSocketImpl$5*
 (make-class-def
      '(class "java.net.SocksSocketImpl$5"
            "java.lang.Object"
            (constant_pool)
            (fields
            ...
            (methods
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (5 (aload_0))
                                      (6 (invokespecial
					(methodCP "<init>" "java.lang.Object" () void)))
                        ...
                        (method "run"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
					...
					(methodCP "access$502" "java.net.SocksSocketImpl" ((class "java.net.SocksSocketImpl") (class "java.net.Socket")) (class "java.net.Socket"))))
                                      (21 (pop))
                                      (22 (aload_0))
                                      (23 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (26 (invokestatic
					(methodCP "access$500" "java.net.SocksSocketImpl" ((class "java.net.SocksSocketImpl")) (class "java.net.Socket"))))
                                      ...
                                      (32 (dup))
                                      (33 (aload_0))
                                      (34 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (37 (invokestatic
					(methodCP "access$300" "java.net.SocksSocketImpl" ((class "java.net.SocksSocketImpl")) (class "java.lang.String"))))
                                      (40 (aload_0))
                                      (41 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (44 (invokestatic
					...
					(methodCP "connect" "java.net.Socket" ((class "java.net.SocketAddress")) void)))
                                      (53 (aload_0))
                                      (54 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (57 (aload_0))
                                      (58 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (61 (invokestatic
					(methodCP "access$500" "java.net.SocksSocketImpl" ((class "java.net.SocksSocketImpl")) (class "java.net.Socket"))))
                                      (64 (invokevirtual
					...
					(methodCP "access$102" "java.net.SocksSocketImpl" ((class "java.net.SocksSocketImpl") (class "java.io.InputStream")) (class "java.io.InputStream"))))
                                      (70 (pop))
                                      (71 (aload_0))
                                      (72 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (75 (aload_0))
                                      (76 (getfield (fieldCP "this$0" "java.net.SocksSocketImpl$5" (class "java.net.SocksSocketImpl"))))
                                      (79 (invokestatic
					(methodCP "access$500" "java.net.SocksSocketImpl" ((class "java.net.SocksSocketImpl")) (class "java.net.Socket"))))
                                      (82 (invokevirtual
                        ...
                        (method "run"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (invokevirtual
					(methodCP "run" "java.net.SocksSocketImpl$5" () (class "java.lang.Void"))))
                                      (4 (areturn))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *SocksSocketImpl$5-class-table*
  (make-static-class-decls 
   *java.net.SocksSocketImpl$5*))

(defconst *package-name-map* 
  ("java.net.SocksSocketImpl$5" . "java.net"))
