; SocketException-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:37 CDT 2014.
;

(defconst *java.net.SocketException*
 (make-class-def
      '(class "java.net.SocketException"
            "java.io.IOException"
            (constant_pool
                        (LONG -5935874303556886934))
            (fields
...
(defconst *SocketException-class-table*
  (make-static-class-decls 
   *java.net.SocketException*))

(defconst *package-name-map* 
  ("java.net.SocketException" . "java.net"))
