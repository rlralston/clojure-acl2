                        ...
                        (method "assign"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (iconst_1))
                                      (2 (invokevirtual
					(methodCP "setHttpOnly" "java.net.HttpCookie" (boolean) void)))
                                      (5 (return))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *HttpCookie$9-class-table*
  (make-static-class-decls 
   *java.net.HttpCookie$9*))

(defconst *package-name-map* 
  ("java.net.HttpCookie$9" . "java.net"))
