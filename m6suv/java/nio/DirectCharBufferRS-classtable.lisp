; DirectCharBufferRS-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:38 CDT 2014.
;

(defconst *java.nio.DirectCharBufferRS*
 (make-class-def
					...
					(methodCP "<init>" "java.nio.DirectCharBufferS" ((class "sun.nio.ch.DirectBuffer") int int int int int) void)))
                        ...
                        (method "slice"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0)) 
                                      (1 (invokevirtual (methodCP "position" "java.nio.DirectCharBufferRS" () int))) 
                                      (4 (istore_1)) 
                                      (5 (aload_0)) 
                                      (6 (invokevirtual (methodCP "limit" "java.nio.DirectCharBufferRS" () int))) 
                                      (9 (istore_2)) 
                                      (10 (getstatic (fieldCP "$assertionsDisabled" "java.nio.DirectCharBufferRS" boolean))) 
                                      (13 (ifne 29)) ;;to TAG_0
                                      (16 (iload_1)) 
                                      (17 (iload_2)) 
                                      ...
                                      (44 (ishl)) 
                                      (45 (istore 4)) 
                                      (47 (getstatic (fieldCP "$assertionsDisabled" "java.nio.DirectCharBufferRS" boolean))) 
                                      (50 (ifne 66)) ;;to TAG_3
                                      (53 (iload 4)) 
                                      (55 (ifge 66)) ;;to TAG_3
                                      ...
                                      (65 (athrow)) 
                                      (66 (new (class "java.nio.DirectCharBufferRS"))) ;;at TAG_3
                                      (69 (dup)) 
                                      (70 (aload_0)) 
                                      (71 (iconst_m1)) 
                                      (72 (iconst_0)) 
                                      ...
                                      (74 (iload_3)) 
                                      (75 (iload 4)) 
                                      (77 (invokespecial (methodCP "<init>" "java.nio.DirectCharBufferRS" ((class "sun.nio.ch.DirectBuffer") int int int int int) void))) 
                                      (80 (areturn)) 
                                      (endofcode 81))
                                   (Exceptions )
                                   (StackMap )))
                        (method "duplicate"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (5 (aload_0))
                                      (6 (invokevirtual
					(methodCP "markValue" "java.nio.DirectCharBufferRS" () int)))
                                      (9 (aload_0))
                                      (10 (invokevirtual
					(methodCP "position" "java.nio.DirectCharBufferRS" () int)))
                                      (13 (aload_0))
                                      (14 (invokevirtual
					(methodCP "limit" "java.nio.DirectCharBufferRS" () int)))
                                      (17 (aload_0))
                                      (18 (invokevirtual
					(methodCP "capacity" "java.nio.DirectCharBufferRS" () int)))
                                      (21 (iconst_0))
                                      (22 (invokespecial
                        ...
                        (method "asReadOnlyBuffer"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (invokevirtual
					(methodCP "duplicate" "java.nio.DirectCharBufferRS" () (class "java.nio.CharBuffer"))))
                                      (4 (areturn))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "toString"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (iload_2)) 
                                      (1 (aload_0)) 
                                      (2 (invokevirtual (methodCP "limit" "java.nio.DirectCharBufferRS" () int))) 
                                      ...
                                      (35 (astore 5)) 
                                      (37 (aload_0)) 
                                      (38 (invokevirtual (methodCP "duplicate" "java.nio.DirectCharBufferRS" () (class "java.nio.CharBuffer")))) 
                                      (41 (astore 6)) 
                                      (43 (aload 6)) 
                                      (45 (iload_1)) 
                        ...
                        (method "subSequence"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (6 (invokevirtual (methodCP "limit" "java.nio.DirectCharBufferRS" () int))) 
                                      (9 (istore 4)) 
                                      (11 (getstatic (fieldCP "$assertionsDisabled" "java.nio.DirectCharBufferRS" boolean))) 
                                      (14 (ifne 31)) ;;to TAG_0
                                      (17 (iload_3)) 
                                      (18 (iload 4)) 
                                      ...
                                      (72 (athrow)) 
                                      (73 (new (class "java.nio.DirectCharBufferRS"))) ;;at TAG_4
                                      (76 (dup)) 
                                      (77 (aload_0)) 
                                      (78 (iconst_m1)) 
                                      (79 (iload_3)) 
                                      ...
                                      (84 (iadd)) 
                                      (85 (aload_0)) 
                                      (86 (invokevirtual (methodCP "capacity" "java.nio.DirectCharBufferRS" () int))) 
                                      (89 (aload_0)) 
                                      (90 (getfield (fieldCP "offset" "java.nio.DirectCharBufferRS" int))) 
                                      (93 (invokespecial (methodCP "<init>" "java.nio.DirectCharBufferRS" ((class "sun.nio.ch.DirectBuffer") int int int int int) void))) 
                                      (96 (areturn)) 
                                      (endofcode 97))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "subSequence"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (2 (iload_2))
                                      (3 (invokevirtual
					(methodCP "subSequence" "java.nio.DirectCharBufferRS" (int int) (class "java.nio.CharBuffer"))))
                                      (6 (areturn))
                                      (endofcode 7))
                                   (Exceptions )
                                   (StackMap )))
                        (method "<clinit>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (14 (putstatic (fieldCP "$assertionsDisabled" "java.nio.DirectCharBufferRS" boolean))) ;;at TAG_1
                                      (17 (return)) 
                                      (endofcode 18))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *DirectCharBufferRS-class-table*
  (make-static-class-decls 
   *java.nio.DirectCharBufferRS*))

(defconst *package-name-map* 
  ("java.nio.DirectCharBufferRS" . "java.nio"))
