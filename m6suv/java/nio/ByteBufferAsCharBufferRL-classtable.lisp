; ByteBufferAsCharBufferRL-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:38 CDT 2014.
;

(defconst *java.nio.ByteBufferAsCharBufferRL*
 (make-class-def
                        ...
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (1 (aload_1))
                                      (2 (invokespecial
					(methodCP "<init>" "java.nio.ByteBufferAsCharBufferL" ((class "java.nio.ByteBuffer")) void)))
                                      (5 (return))
                                      (endofcode 6))
                                   (Exceptions )
                                   (StackMap )))
					...
					(methodCP "<init>" "java.nio.ByteBufferAsCharBufferL" ((class "java.nio.ByteBuffer") int int int int int) void)))
                        ...
                        (method "slice"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0)) 
                                      (1 (invokevirtual (methodCP "position" "java.nio.ByteBufferAsCharBufferRL" () int))) 
                                      (4 (istore_1)) 
                                      (5 (aload_0)) 
                                      (6 (invokevirtual (methodCP "limit" "java.nio.ByteBufferAsCharBufferRL" () int))) 
                                      (9 (istore_2)) 
                                      (10 (getstatic (fieldCP "$assertionsDisabled" "java.nio.ByteBufferAsCharBufferRL" boolean))) 
                                      (13 (ifne 29)) ;;to TAG_0
                                      (16 (iload_1)) 
                                      (17 (iload_2)) 
                                      ...
                                      (44 (ishl)) 
                                      (45 (aload_0)) 
                                      (46 (getfield (fieldCP "offset" "java.nio.ByteBufferAsCharBufferRL" int))) 
                                      (49 (iadd)) 
                                      (50 (istore 4)) 
                                      (52 (getstatic (fieldCP "$assertionsDisabled" "java.nio.ByteBufferAsCharBufferRL" boolean))) 
                                      (55 (ifne 71)) ;;to TAG_3
                                      (58 (iload 4)) 
                                      (60 (ifge 71)) ;;to TAG_3
                                      ...
                                      (70 (athrow)) 
                                      (71 (new (class "java.nio.ByteBufferAsCharBufferRL"))) ;;at TAG_3
                                      (74 (dup)) 
                                      (75 (aload_0)) 
                                      (76 (getfield (fieldCP "bb" "java.nio.ByteBufferAsCharBufferRL" (class "java.nio.ByteBuffer")))) 
                                      (79 (iconst_m1)) 
                                      (80 (iconst_0)) 
                                      (81 (iload_3)) 
                                      (82 (iload_3)) 
                                      (83 (iload 4)) 
                                      (85 (invokespecial (methodCP "<init>" "java.nio.ByteBufferAsCharBufferRL" ((class "java.nio.ByteBuffer") int int int int int) void))) 
                                      (88 (areturn)) 
                                      (endofcode 89))
                                   (Exceptions )
                                   (StackMap )))
                        (method "duplicate"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (3 (dup))
                                      (4 (aload_0))
                                      (5 (getfield (fieldCP "bb" "java.nio.ByteBufferAsCharBufferRL" (class "java.nio.ByteBuffer"))))
                                      (8 (aload_0))
                                      (9 (invokevirtual
					(methodCP "markValue" "java.nio.ByteBufferAsCharBufferRL" () int)))
                                      (12 (aload_0))
                                      (13 (invokevirtual
					(methodCP "position" "java.nio.ByteBufferAsCharBufferRL" () int)))
                                      (16 (aload_0))
                                      (17 (invokevirtual
					(methodCP "limit" "java.nio.ByteBufferAsCharBufferRL" () int)))
                                      (20 (aload_0))
                                      (21 (invokevirtual
					(methodCP "capacity" "java.nio.ByteBufferAsCharBufferRL" () int)))
                                      (24 (aload_0))
                                      (25 (getfield (fieldCP "offset" "java.nio.ByteBufferAsCharBufferRL" int)))
                                      (28 (invokespecial
                        ...
                        (method "asReadOnlyBuffer"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (invokevirtual
					(methodCP "duplicate" "java.nio.ByteBufferAsCharBufferRL" () (class "java.nio.CharBuffer"))))
                                      (4 (areturn))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap )))
					...
					(methodCP "<init>" "java.nio.ReadOnlyBufferException" () void)))
                        ...
                        (method "isDirect"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (getfield (fieldCP "bb" "java.nio.ByteBufferAsCharBufferRL" (class "java.nio.ByteBuffer"))))
                                      (4 (invokevirtual
                        ...
                        (method "toString"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (iload_2)) 
                                      (1 (aload_0)) 
                                      (2 (invokevirtual (methodCP "limit" "java.nio.ByteBufferAsCharBufferRL" () int))) 
                                      ...
                                      (35 (astore 5)) 
                                      (37 (aload_0)) 
                                      (38 (invokevirtual (methodCP "duplicate" "java.nio.ByteBufferAsCharBufferRL" () (class "java.nio.CharBuffer")))) 
                                      (41 (astore 6)) 
                                      (43 (aload 6)) 
                                      (45 (iload_1)) 
                        ...
                        (method "subSequence"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (6 (invokevirtual (methodCP "limit" "java.nio.ByteBufferAsCharBufferRL" () int))) 
                                      (9 (istore 4)) 
                                      (11 (getstatic (fieldCP "$assertionsDisabled" "java.nio.ByteBufferAsCharBufferRL" boolean))) 
                                      (14 (ifne 31)) ;;to TAG_0
                                      (17 (iload_3)) 
                                      (18 (iload 4)) 
                                      ...
                                      (72 (athrow)) 
                                      (73 (new (class "java.nio.ByteBufferAsCharBufferRL"))) ;;at TAG_4
                                      (76 (dup)) 
                                      (77 (aload_0)) 
                                      (78 (getfield (fieldCP "bb" "java.nio.ByteBufferAsCharBufferRL" (class "java.nio.ByteBuffer")))) 
                                      (81 (iconst_m1)) 
                                      (82 (iload_3)) 
                                      (83 (iload_1)) 
                                      (84 (iadd)) 
                                      ...
                                      (87 (iadd)) 
                                      (88 (aload_0)) 
                                      (89 (invokevirtual (methodCP "capacity" "java.nio.ByteBufferAsCharBufferRL" () int))) 
                                      (92 (aload_0)) 
                                      (93 (getfield (fieldCP "offset" "java.nio.ByteBufferAsCharBufferRL" int))) 
                                      (96 (invokespecial (methodCP "<init>" "java.nio.ByteBufferAsCharBufferRL" ((class "java.nio.ByteBuffer") int int int int int) void))) 
                                      (99 (areturn)) 
                                      (endofcode 100))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "subSequence"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (2 (iload_2))
                                      (3 (invokevirtual
					(methodCP "subSequence" "java.nio.ByteBufferAsCharBufferRL" (int int) (class "java.nio.CharBuffer"))))
                                      (6 (areturn))
                                      (endofcode 7))
                                   (Exceptions )
                                   (StackMap )))
                        (method "<clinit>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (14 (putstatic (fieldCP "$assertionsDisabled" "java.nio.ByteBufferAsCharBufferRL" boolean))) ;;at TAG_1
                                      (17 (return)) 
                                      (endofcode 18))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *ByteBufferAsCharBufferRL-class-table*
  (make-static-class-decls 
   *java.nio.ByteBufferAsCharBufferRL*))

(defconst *package-name-map* 
  ("java.nio.ByteBufferAsCharBufferRL" . "java.nio"))
