; Pipe$SinkChannel-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:38 CDT 2014.
;

(defconst *java.nio.channels.Pipe$SinkChannel*
 (make-class-def
					...
					(methodCP "<init>" "java.nio.channels.spi.AbstractSelectableChannel" ((class "java.nio.channels.spi.SelectorProvider")) void)))
                        ...
                        (method "validOps"
                              ...
                              (code
                                   ...
                                   (Exceptions )
                                   (StackMap ))))
            (interfaces "java.nio.channels.WritableByteChannel" "java.nio.channels.GatheringByteChannel")
...
(defconst *Pipe$SinkChannel-class-table*
  (make-static-class-decls 
   *java.nio.channels.Pipe$SinkChannel*))

(defconst *package-name-map* 
  ("java.nio.channels.Pipe$SinkChannel" . "java.nio.channels"))
