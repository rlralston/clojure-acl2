; DirectDoubleBufferRS-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:38 CDT 2014.
;

(defconst *java.nio.DirectDoubleBufferRS*
 (make-class-def
					...
					(methodCP "<init>" "java.nio.DirectDoubleBufferS" ((class "sun.nio.ch.DirectBuffer") int int int int int) void)))
                        ...
                        (method "slice"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0)) 
                                      (1 (invokevirtual (methodCP "position" "java.nio.DirectDoubleBufferRS" () int))) 
                                      (4 (istore_1)) 
                                      (5 (aload_0)) 
                                      (6 (invokevirtual (methodCP "limit" "java.nio.DirectDoubleBufferRS" () int))) 
                                      (9 (istore_2)) 
                                      (10 (getstatic (fieldCP "$assertionsDisabled" "java.nio.DirectDoubleBufferRS" boolean))) 
                                      (13 (ifne 29)) ;;to TAG_0
                                      (16 (iload_1)) 
                                      (17 (iload_2)) 
                                      ...
                                      (44 (ishl)) 
                                      (45 (istore 4)) 
                                      (47 (getstatic (fieldCP "$assertionsDisabled" "java.nio.DirectDoubleBufferRS" boolean))) 
                                      (50 (ifne 66)) ;;to TAG_3
                                      (53 (iload 4)) 
                                      (55 (ifge 66)) ;;to TAG_3
                                      ...
                                      (65 (athrow)) 
                                      (66 (new (class "java.nio.DirectDoubleBufferRS"))) ;;at TAG_3
                                      (69 (dup)) 
                                      (70 (aload_0)) 
                                      (71 (iconst_m1)) 
                                      (72 (iconst_0)) 
                                      ...
                                      (74 (iload_3)) 
                                      (75 (iload 4)) 
                                      (77 (invokespecial (methodCP "<init>" "java.nio.DirectDoubleBufferRS" ((class "sun.nio.ch.DirectBuffer") int int int int int) void))) 
                                      (80 (areturn)) 
                                      (endofcode 81))
                                   (Exceptions )
                                   (StackMap )))
                        (method "duplicate"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (5 (aload_0))
                                      (6 (invokevirtual
					(methodCP "markValue" "java.nio.DirectDoubleBufferRS" () int)))
                                      (9 (aload_0))
                                      (10 (invokevirtual
					(methodCP "position" "java.nio.DirectDoubleBufferRS" () int)))
                                      (13 (aload_0))
                                      (14 (invokevirtual
					(methodCP "limit" "java.nio.DirectDoubleBufferRS" () int)))
                                      (17 (aload_0))
                                      (18 (invokevirtual
					(methodCP "capacity" "java.nio.DirectDoubleBufferRS" () int)))
                                      (21 (iconst_0))
                                      (22 (invokespecial
                        ...
                        (method "asReadOnlyBuffer"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (invokevirtual
					(methodCP "duplicate" "java.nio.DirectDoubleBufferRS" () (class "java.nio.DoubleBuffer"))))
                                      (4 (areturn))
                                      (endofcode 5))
                                   (Exceptions )
                                   (StackMap )))
                        ...
                        (method "<clinit>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (14 (putstatic (fieldCP "$assertionsDisabled" "java.nio.DirectDoubleBufferRS" boolean))) ;;at TAG_1
                                      (17 (return)) 
                                      (endofcode 18))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *DirectDoubleBufferRS-class-table*
  (make-static-class-decls 
   *java.nio.DirectDoubleBufferRS*))

(defconst *package-name-map* 
  ("java.nio.DirectDoubleBufferRS" . "java.nio"))
