...
(defconst *ProviderNotFoundException-class-table*
  (make-static-class-decls 
   *java.nio.file.ProviderNotFoundException*))

(defconst *package-name-map* 
  ("java.nio.file.ProviderNotFoundException" . "java.nio.file"))
