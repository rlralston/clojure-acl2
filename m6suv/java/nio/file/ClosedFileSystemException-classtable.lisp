...
(defconst *ClosedFileSystemException-class-table*
  (make-static-class-decls 
   *java.nio.file.ClosedFileSystemException*))

(defconst *package-name-map* 
  ("java.nio.file.ClosedFileSystemException" . "java.nio.file"))
