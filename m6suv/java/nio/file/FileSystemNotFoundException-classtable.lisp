...
(defconst *FileSystemNotFoundException-class-table*
  (make-static-class-decls 
   *java.nio.file.FileSystemNotFoundException*))

(defconst *package-name-map* 
  ("java.nio.file.FileSystemNotFoundException" . "java.nio.file"))
