...
(defconst *FileAlreadyExistsException-class-table*
  (make-static-class-decls 
   *java.nio.file.FileAlreadyExistsException*))

(defconst *package-name-map* 
  ("java.nio.file.FileAlreadyExistsException" . "java.nio.file"))
