; java_util_Collections$CheckedCollection_PersistenceDelegate-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:31 CDT 2014.
;

(defconst *java.beans.java_util_Collections$CheckedCollection_PersistenceDelegate*
 (make-class-def
      '(class "java.beans.java_util_Collections$CheckedCollection_PersistenceDelegate"
            "java.beans.java_util_Collections"
            (constant_pool
                        (STRING  "java.util.Collections$CheckedCollection.type")
                        (STRING  "checkedCollection"))
            (fields)
            (methods
                        (method "<init>"
                              (parameters )
					...
					(methodCP "<init>" "java.util.ArrayList" ((class "java.util.Collection")) void)))
                                      ...
                                      (24 (aload_1))
                                      (25 (ldc_w ))
                                      (28 (ldc 1))        ;;STRING:: "checkedCollection"
                                      (30 (iconst_2))
...
(defconst *java_util_Collections$CheckedCollection_PersistenceDelegate-class-table*
  (make-static-class-decls 
   *java.beans.java_util_Collections$CheckedCollection_PersistenceDelegate*))

(defconst *package-name-map* 
  ("java.beans.java_util_Collections$CheckedCollection_PersistenceDelegate" . "java.beans"))
