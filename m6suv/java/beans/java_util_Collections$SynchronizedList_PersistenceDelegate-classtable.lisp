; java_util_Collections$SynchronizedList_PersistenceDelegate-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:31 CDT 2014.
;

(defconst *java.beans.java_util_Collections$SynchronizedList_PersistenceDelegate*
 (make-class-def
      '(class "java.beans.java_util_Collections$SynchronizedList_PersistenceDelegate"
            "java.beans.java_util_Collections"
            (constant_pool
                        (STRING  "synchronizedList"))
            (fields)
            (methods
                        (method "<init>"
                              (parameters )
					...
					(methodCP "<init>" "java.util.LinkedList" ((class "java.util.Collection")) void)))
                                      ...
                                      (16 (aload_1))
                                      (17 (ldc_w ))
                                      (20 (ldc 0))        ;;STRING:: "synchronizedList"
                                      (22 (iconst_1))
...
(defconst *java_util_Collections$SynchronizedList_PersistenceDelegate-class-table*
  (make-static-class-decls 
   *java.beans.java_util_Collections$SynchronizedList_PersistenceDelegate*))

(defconst *package-name-map* 
  ("java.beans.java_util_Collections$SynchronizedList_PersistenceDelegate" . "java.beans"))
