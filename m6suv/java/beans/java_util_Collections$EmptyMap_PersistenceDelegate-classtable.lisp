; java_util_Collections$EmptyMap_PersistenceDelegate-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:31 CDT 2014.
;

(defconst *java.beans.java_util_Collections$EmptyMap_PersistenceDelegate*
 (make-class-def
      '(class "java.beans.java_util_Collections$EmptyMap_PersistenceDelegate"
...
(defconst *java_util_Collections$EmptyMap_PersistenceDelegate-class-table*
  (make-static-class-decls 
   *java.beans.java_util_Collections$EmptyMap_PersistenceDelegate*))

(defconst *package-name-map* 
  ("java.beans.java_util_Collections$EmptyMap_PersistenceDelegate" . "java.beans"))
