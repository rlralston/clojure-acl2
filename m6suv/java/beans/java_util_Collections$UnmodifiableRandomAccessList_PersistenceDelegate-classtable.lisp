; java_util_Collections$UnmodifiableRandomAccessList_PersistenceDelegate-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:31 CDT 2014.
;

(defconst *java.beans.java_util_Collections$UnmodifiableRandomAccessList_PersistenceDelegate*
 (make-class-def
      '(class "java.beans.java_util_Collections$UnmodifiableRandomAccessList_PersistenceDelegate"
            ...
            (methods
                        ...
                        (method "instantiate"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      ...
                                      (3 (dup))
                                      (4 (aload_1))
                                      (5 (checkcast (class "java.util.Collection")))
                                      (8 (invokespecial
					(methodCP "<init>" "java.util.ArrayList" ((class "java.util.Collection")) void)))
                                      ...
                                      (16 (aload_1))
                                      (17 (ldc_w ))
                                      (20 (ldc 0))        ;;STRING:: "unmodifiableList"
                                      (22 (iconst_1))
...
(defconst *java_util_Collections$UnmodifiableRandomAccessList_PersistenceDelegate-class-table*
  (make-static-class-decls 
   *java.beans.java_util_Collections$UnmodifiableRandomAccessList_PersistenceDelegate*))

(defconst *package-name-map* 
  ("java.beans.java_util_Collections$UnmodifiableRandomAccessList_PersistenceDelegate" . "java.beans"))
