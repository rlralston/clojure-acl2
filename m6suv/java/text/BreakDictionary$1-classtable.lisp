; BreakDictionary$1-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:41 CDT 2014.
;

(defconst *java.text.BreakDictionary$1*
 (make-class-def
      '(class "java.text.BreakDictionary$1"
            "java.lang.Object"
            (constant_pool
                        (STRING  "/sun/text/resources/"))
            (fields
                        (field "val$dictionaryName" (class "java.lang.String") (accessflags  *class*  *final* ) -1)
                        (field "this$0" (class "java.text.BreakDictionary") (accessflags  *class*  *final* ) -1))
            (methods
                        (method "<init>"
                              (parameters (class "java.text.BreakDictionary") (class "java.lang.String"))
                              (returntype . void)
                              (accessflags  *class* )
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "this$0" "java.text.BreakDictionary$1" (class "java.text.BreakDictionary"))))
                                      (5 (aload_0))
                                      (6 (aload_2))
                                      (7 (putfield (fieldCP "val$dictionaryName" "java.text.BreakDictionary$1" (class "java.lang.String"))))
                                      (10 (aload_0))
                                      (11 (invokespecial
					...
					(methodCP "append" "java.lang.StringBuilder" ((class "java.lang.String")) (class "java.lang.StringBuilder"))))
                                      (20 (aload_0))
                                      (21 (getfield (fieldCP "val$dictionaryName" "java.text.BreakDictionary$1" (class "java.lang.String"))))
                                      (24 (invokevirtual
					(methodCP "append" "java.lang.StringBuilder" ((class "java.lang.String")) (class "java.lang.StringBuilder"))))
                                      (27 (invokevirtual
...
(defconst *BreakDictionary$1-class-table*
  (make-static-class-decls 
   *java.text.BreakDictionary$1*))

(defconst *package-name-map* 
  ("java.text.BreakDictionary$1" . "java.text"))
