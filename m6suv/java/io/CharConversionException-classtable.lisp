...
(defconst *CharConversionException-class-table*
  (make-static-class-decls 
   *java.io.CharConversionException*))

(defconst *package-name-map* 
  ("java.io.CharConversionException" . "java.io"))
