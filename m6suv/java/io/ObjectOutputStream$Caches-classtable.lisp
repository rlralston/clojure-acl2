; ObjectOutputStream$Caches-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:32 CDT 2014.
;

(defconst *java.io.ObjectOutputStream$Caches*
 (make-class-def
      '(class "java.io.ObjectOutputStream$Caches"
            ...
            (methods
					...
					(methodCP "<init>" "java.util.concurrent.ConcurrentHashMap" () void)))
                                      (7 (putstatic (fieldCP "subclassAudits" "java.io.ObjectOutputStream$Caches" (class "java.util.concurrent.ConcurrentMap"))))
                                      (10 (new (class "java.lang.ref.ReferenceQueue")))
                                      (13 (dup))
                                      (14 (invokespecial
					(methodCP "<init>" "java.lang.ref.ReferenceQueue" () void)))
                                      (17 (putstatic (fieldCP "subclassAuditsQueue" "java.io.ObjectOutputStream$Caches" (class "java.lang.ref.ReferenceQueue"))))
                                      (20 (return))
                                      (endofcode 21))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *ObjectOutputStream$Caches-class-table*
  (make-static-class-decls 
   *java.io.ObjectOutputStream$Caches*))

(defconst *package-name-map* 
  ("java.io.ObjectOutputStream$Caches" . "java.io"))
