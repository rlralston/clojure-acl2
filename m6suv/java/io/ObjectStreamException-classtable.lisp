...
(defconst *ObjectStreamException-class-table*
  (make-static-class-decls 
   *java.io.ObjectStreamException*))

(defconst *package-name-map* 
  ("java.io.ObjectStreamException" . "java.io"))
