; InvalidAlgorithmParameterException-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:40 CDT 2014.
;

(defconst *java.security.InvalidAlgorithmParameterException*
 (make-class-def
      '(class "java.security.InvalidAlgorithmParameterException"
            "java.security.GeneralSecurityException"
            (constant_pool
                        (LONG 2864672297499471472))
            (fields
...
(defconst *InvalidAlgorithmParameterException-class-table*
  (make-static-class-decls 
   *java.security.InvalidAlgorithmParameterException*))

(defconst *package-name-map* 
  ("java.security.InvalidAlgorithmParameterException" . "java.security"))
