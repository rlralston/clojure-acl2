...
(defconst *KeyStoreException-class-table*
  (make-static-class-decls 
   *java.security.KeyStoreException*))

(defconst *package-name-map* 
  ("java.security.KeyStoreException" . "java.security"))
