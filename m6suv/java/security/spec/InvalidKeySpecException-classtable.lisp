...
(defconst *InvalidKeySpecException-class-table*
  (make-static-class-decls 
   *java.security.spec.InvalidKeySpecException*))

(defconst *package-name-map* 
  ("java.security.spec.InvalidKeySpecException" . "java.security.spec"))
