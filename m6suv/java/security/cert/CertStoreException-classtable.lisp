...
(defconst *CertStoreException-class-table*
  (make-static-class-decls 
   *java.security.cert.CertStoreException*))

(defconst *package-name-map* 
  ("java.security.cert.CertStoreException" . "java.security.cert"))
