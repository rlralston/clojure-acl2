...
(defconst *CRLException-class-table*
  (make-static-class-decls 
   *java.security.cert.CRLException*))

(defconst *package-name-map* 
  ("java.security.cert.CRLException" . "java.security.cert"))
