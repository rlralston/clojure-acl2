...
(defconst *ProviderException-class-table*
  (make-static-class-decls 
   *java.security.ProviderException*))

(defconst *package-name-map* 
  ("java.security.ProviderException" . "java.security"))
