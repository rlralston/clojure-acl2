...
(defconst *NoSuchAlgorithmException-class-table*
  (make-static-class-decls 
   *java.security.NoSuchAlgorithmException*))

(defconst *package-name-map* 
  ("java.security.NoSuchAlgorithmException" . "java.security"))
