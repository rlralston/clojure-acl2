...
(defconst *UnrecoverableEntryException-class-table*
  (make-static-class-decls 
   *java.security.UnrecoverableEntryException*))

(defconst *package-name-map* 
  ("java.security.UnrecoverableEntryException" . "java.security"))
