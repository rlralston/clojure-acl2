...
(defconst *DigestException-class-table*
  (make-static-class-decls 
   *java.security.DigestException*))

(defconst *package-name-map* 
  ("java.security.DigestException" . "java.security"))
