...
(defconst *SignatureException-class-table*
  (make-static-class-decls 
   *java.security.SignatureException*))

(defconst *package-name-map* 
  ("java.security.SignatureException" . "java.security"))
