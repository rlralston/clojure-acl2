...
(defconst *NotBoundException-class-table*
  (make-static-class-decls 
   *java.rmi.NotBoundException*))

(defconst *package-name-map* 
  ("java.rmi.NotBoundException" . "java.rmi"))
