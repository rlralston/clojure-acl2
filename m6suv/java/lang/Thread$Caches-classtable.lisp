      ...
      '(class "java.lang.Thread$Caches"
            ...
            (methods
					...
					(methodCP "<init>" "java.util.concurrent.ConcurrentHashMap" () void)))
                                      (7 (putstatic (fieldCP "subclassAudits" "java.lang.Thread$Caches" (class "java.util.concurrent.ConcurrentMap"))))
                                      (10 (new (class "java.lang.ref.ReferenceQueue")))
                                      (13 (dup))
                                      (14 (invokespecial
					(methodCP "<init>" "java.lang.ref.ReferenceQueue" () void)))
                                      (17 (putstatic (fieldCP "subclassAuditsQueue" "java.lang.Thread$Caches" (class "java.lang.ref.ReferenceQueue"))))
                                      (20 (return))
                                      (endofcode 21))
                                   (Exceptions )
                                   (StackMap ))))
...
(defconst *Thread$Caches-class-table*
  (make-static-class-decls 
   *java.lang.Thread$Caches*))

(defconst *package-name-map* 
  ("java.lang.Thread$Caches" . "java.lang"))
