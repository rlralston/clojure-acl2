; CheckboxMenuItem$AccessibleAWTCheckboxMenuItem-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:24 CDT 2014.
;

(defconst *java.awt.CheckboxMenuItem$AccessibleAWTCheckboxMenuItem*
 (make-class-def
      '(class "java.awt.CheckboxMenuItem$AccessibleAWTCheckboxMenuItem"
            "java.awt.MenuItem$AccessibleAWTMenuItem"
            (constant_pool
                        (LONG -1122642964303476))
            (fields
                        (field "serialVersionUID" long (accessflags  *class*  *final*  *private*  *static* ) 0)
                        (field "this$0" (class "java.awt.CheckboxMenuItem") (accessflags  *class*  *final* ) -1))
            (methods
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "this$0" "java.awt.CheckboxMenuItem$AccessibleAWTCheckboxMenuItem" (class "java.awt.CheckboxMenuItem"))))
                                      (5 (aload_0))
                                      (6 (aload_1))
                                      (7 (invokespecial
					(methodCP "<init>" "java.awt.MenuItem$AccessibleAWTMenuItem" ((class "java.awt.MenuItem")) void)))
                                      (10 (return))
                                      (endofcode 11))
                                   (Exceptions )
                                   (StackMap )))
...
(defconst *CheckboxMenuItem$AccessibleAWTCheckboxMenuItem-class-table*
  (make-static-class-decls 
   *java.awt.CheckboxMenuItem$AccessibleAWTCheckboxMenuItem*))

(defconst *package-name-map* 
  ("java.awt.CheckboxMenuItem$AccessibleAWTCheckboxMenuItem" . "java.awt"))
