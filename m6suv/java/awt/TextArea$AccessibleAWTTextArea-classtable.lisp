; TextArea$AccessibleAWTTextArea-classtable.lisp
; Automatically generated by jvm2acl2 on Tue May 27 00:39:30 CDT 2014.
;

(defconst *java.awt.TextArea$AccessibleAWTTextArea*
 (make-class-def
      '(class "java.awt.TextArea$AccessibleAWTTextArea"
            "java.awt.TextComponent$AccessibleAWTTextComponent"
            (constant_pool
                        (LONG 3472827823632144419))
            (fields
                        (field "serialVersionUID" long (accessflags  *class*  *final*  *private*  *static* ) 0)
                        (field "this$0" (class "java.awt.TextArea") (accessflags  *class*  *final* ) -1))
            (methods
                        (method "<init>"
                              ...
                              (code
                                   ...
                                   (parsedcode
                                      (0 (aload_0))
                                      (1 (aload_1))
                                      (2 (putfield (fieldCP "this$0" "java.awt.TextArea$AccessibleAWTTextArea" (class "java.awt.TextArea"))))
                                      (5 (aload_0))
                                      (6 (aload_1))
                                      (7 (invokespecial
					...
					(methodCP "getAccessibleStateSet" "java.awt.TextComponent$AccessibleAWTTextComponent" () (class "javax.accessibility.AccessibleStateSet"))))
                                      (4 (astore_1))
                                      (5 (aload_1))
                                      (6 (getstatic (fieldCP "MULTI_LINE" "javax.accessibility.AccessibleState" (class "javax.accessibility.AccessibleState"))))
                                      (9 (invokevirtual
...
(defconst *TextArea$AccessibleAWTTextArea-class-table*
  (make-static-class-decls 
   *java.awt.TextArea$AccessibleAWTTextArea*))

(defconst *package-name-map* 
  ("java.awt.TextArea$AccessibleAWTTextArea" . "java.awt"))
